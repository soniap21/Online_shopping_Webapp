...
<body>
<div style="color: black; text-align: center; font-size: 30px;"><b>My Cart</b> <i class='fas fa-cart-arrow-down'></i></div>
<%
...
%>
          <tr>
            <th scope="col" style="background-color: #ff6f6f;">Total: <i class="fa fa-inr"></i> <%out.println(total);%></th>
