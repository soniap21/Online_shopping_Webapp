...
%>
          ...
          <th scope="col"><a href="myCart.jsp"><i class='fas fa-arrow-circle-left'> Back</i></a></th>
            <th scope="col" style="background-color: #f89cac;">Total: <i class="fa fa-inr"></i><%out.println(total); %> </th>
          </tr>
        </thead>
        <thead>
          <tr>
...
<h3 style="color: #710c04">*If there is no address its mean that you did not set you address!</h3>
<h3 style="color: #710c04">*This address will also updated to your profile</h3>
<hr style="width: 100%">
<div class="left-div">
...
<div class="right-div">
<h3>Pay online on this sonia@pay.com</h3>
<input class="input-style" type="text" name="transactionId" placeholder="Enter Transaction ID">
<h3 style="color: #710c04">*If you select online Payment then enter you transaction ID here otherwise leave this blank</h3>
</div>
<hr style="width: 100%">
...
<h3 style="color: #710c04">*This mobile number will also updated to your profile</h3>
</div>
<div class="right-div">
<h3 style="color: #710c04">*If you enter wrong transaction id then your order will we can cancel!</h3>
<button class="button">Proceed to Generate Bill & Save <i class='far fa-arrow-alt-circle-right'></i> </button>
<h3 style="color: #710c04">*Fill form correctly</h3>
</div>
</form>
<%
      }
